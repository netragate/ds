...
export const playgroundPropCoverage: Record<string, readonly string[]> = {
  ...
  Input: ['type', 'size', 'placeholder', 'minLength', 'maxLength', 'accept', 'multiple', 'disabled', 'readonly', 'error', 'success', 'message'],
  ...
  Select: ['multiple', 'searchable', 'creatable', 'serverSearch', 'minSearchChars', 'loading', 'disabled', 'placeholder'],
