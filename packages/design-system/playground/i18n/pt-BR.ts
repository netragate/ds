...
/>`,
  ...
  dataTable: {
    ...
    hints: [
      ...
      'No modo API, os filtros de coluna exigem Aplicar antes de recarregar os dados.',
      'Ative expandable para abrir uma tabela aninhada estática por vez (eager ou lazy).',
    ],
    sortLabel: 'Ordenação:',
    ...
    labels: {
      ...
      expandLoadingText: 'Carregando detalhes…',
    },
  },
  drawer: {
    ...
    descriptions: {
      ...
      Input: 'Campo de texto com estados de erro, sucesso, desabilitado e upload type=file.',
