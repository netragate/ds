...
- `createLocaleWrapper()` --calls--> `providePlaygroundLocale()`  [EXTRACTED]
  packages/design-system/tests/HomeChangelogSection.spec.ts → packages/design-system/playground/composables/usePlaygroundLocale.ts
- `createLocaleWrapper()` --calls--> `providePlaygroundLocale()`  [EXTRACTED]
...
Cohesion: 0.10
Nodes (34): componentCatalogEntries, c(), cls(), e(), m(), p(), s(), getComponentCatalogEntry() (+26 more)
...
Cohesion: 0.04
Nodes (44): Abordagem de property-based testing, Architecture, Arquivos a modificar, Atualização: `Button.props[0]` (`variant`), Components and Interfaces, Correctness Properties, Data Models, Demo Designs (+36 more)
...
Cohesion: 0.04
Nodes (44): Architecture, Biblioteca de PBT recomendada, Cobertura complementar, Components and Interfaces, Correctness Properties, Data Models, Design Document — Design System UI Improvements, Error Handling (+36 more)
...
Cohesion: 0.11
Nodes (18): activeNav, defaultCollapsed, menuCollapsed, menuCollapsedWidth, menuCollapsedWidthRem, menuCollapsible, menuLabel, navLabels (+10 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (17): ADDED Requirements, Requirement: Browser back/forward navigation works, Requirement: Catalog component selection via URL hash, Requirement: Header navigation uses router links, Requirement: Mobile category nav navigates via router, Requirement: Playground pages are accessible via URL routes, Scenario: Active route is reflected in header nav, Scenario: Back button returns to previous page (+9 more)
...
Cohesion: 0.15
Nodes (12): ADDED Requirements, Requirement: Ghost button uses text-hovered on hover, Requirement: Other components retain existing hover behavior, Requirement: Outline button uses text-hovered on hover, Requirement: System provides a text-hovered design token, Scenario: DateInput navigation hover unchanged, Scenario: Ghost button default state is unchanged, Scenario: Ghost button uses text-hovered on hover (+4 more)
...
Cohesion: 0.22
Nodes (8): Bug Analysis, Bugfix Requirements Document, Componentes Afetados, Componentes de Referência (padrão correto), Current Behavior (Defect), Expected Behavior (Correct), Introduction, Unchanged Behavior (Regression Prevention)
...
Cohesion: 0.33
Nodes (5): Implementation Plan: Alinhamento ao Atlassian Design System, Notes, Overview, Task Dependency Graph, Tasks

### Community 82 - "Community 82"
Cohesion: 0.33
Nodes (5): Implementation Plan: Design System Homepage Revamp, Notes, Overview, Task Dependency Graph, Tasks

### Community 83 - "Community 83"
Cohesion: 0.33
Nodes (5): Implementation Plan: design-system-playground-docs-update, Notes, Overview, Task Dependency Graph, Tasks

### Community 84 - "Community 84"
Cohesion: 0.33
Nodes (5): Implementation Plan: Design System UI Improvements, Notes, Overview, Task Dependency Graph, Tasks
...
Cohesion: 0.60
Nodes (5): assertNoRawI18nKeys(), collectLeafTexts(), createLocaleWrapper(), isRawI18nKey(), mountSectionWithLocale()
...
Cohesion: 0.50
Nodes (3): Image, main(), to_transparent()

### Community 94 - "Community 94"
Cohesion: 0.50
Nodes (3): 1. Design Tokens, 2. Button Variants, 3. Verification

### Community 95 - "Community 95"
Cohesion: 0.50
Nodes (4): 20. Motion e Animação (Requisito 22), Override `prefers-reduced-motion` em `theme.css`, Padrão recomendado para componentes, Tokens de motion em `tokens.css`

### Community 96 - "Community 96"
Cohesion: 0.50
Nodes (4): 2. Button — Novas variantes e ButtonGroup, 2a. `buttonVariants.ts` — adicionar `warning`, `discovery`, `isSelected`, 2b. `Button.vue` — novas props, 2c. `ButtonGroup.vue` — novo componente
...
Cohesion: 0.50
Nodes (3): BASE_TOKEN_VALUES, NON_INSTANT_DURATION_TOKENS, NonInstantDurationToken

### Community 104 - "Community 104"
Cohesion: 0.50
Nodes (3): PRIMITIVE_VALUES, SEMANTIC_TO_PRIMITIVE, SEMANTIC_TOKENS

### Community 105 - "Community 105"
Cohesion: 0.67
Nodes (3): 11. Flag / FlagGroup — novos componentes, `Flag.vue`, `FlagGroup.vue`

### Community 106 - "Community 106"
Cohesion: 0.67
Nodes (3): 12. Tag / TagGroup — novos componentes, `Tag.vue`, `TagGroup.vue`

### Community 107 - "Community 107"
Cohesion: 0.67
Nodes (3): 18. Gradientes (Requisito 20), Override no tema dark (`theme.css`), Tokens de gradiente em `tokens.css`

### Community 108 - "Community 108"
Cohesion: 0.67
Nodes (3): 19. Border Radius (Requisito 21), Bridge no `@theme inline` de `theme.css`, Escala primitiva e tokens semânticos em `tokens.css`

### Community 109 - "Community 109"
Cohesion: 0.67
Nodes (3): 1. Token Layer (tokens.css + theme.css), 1a. Novos tokens semânticos em `tokens.css`, 1b. Extensão do `theme.css` — bridge para Tailwind

### Community 110 - "Community 110"
Cohesion: 0.67
Nodes (3): 21. Shadow Scale (Requisito 23), Escala primitiva e tokens semânticos em `tokens.css`, Override no tema dark

### Community 111 - "Community 111"
Cohesion: 0.67
Nodes (3): 23. Tokens de Cor para Ícones (Requisito 25), Bridge no `@theme inline` de `theme.css`, Tokens em `tokens.css`

### Community 112 - "Community 112"
Cohesion: 0.67
Nodes (3): 24. Z-Index Scale (Requisito 26), Mapeamento de componentes existentes, Tokens em `tokens.css`

### Community 113 - "Community 113"
Cohesion: 0.67
Nodes (3): 25. Border Widths e Styles (Requisito 27), Bridge no `@theme inline` de `theme.css`, Tokens em `tokens.css`

### Community 114 - "Community 114"
Cohesion: 0.67
Nodes (3): 6. Modal — subcomponentes, `Modal.vue` — atualização, Novos arquivos
